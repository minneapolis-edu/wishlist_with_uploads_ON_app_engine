...
DATABASES = {
    'default': {
        ...
        'NAME': 'wishlist',
        'USER': 'django_web_app',
        'PASSWORD': os.getenv('WISHLIST_DB_PW'),  # TODO set this
        'HOST': '/cloudsql/strong-province-113523:us-central1:travel-wishlist-db',
        'PORT': '5432'
    }
}
...
if os.getenv('GAE_INSTANCE'):
    ...
    GS_BUCKET_NAME = 'user-place-images'
    GS_STATIC_APP_FILES_BUCKET = 'strong-province-113523.appspot.com'
